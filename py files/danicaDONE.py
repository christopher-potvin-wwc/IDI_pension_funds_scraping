        ...
        if text:
            ...
            for line in lines: 
                ...
                if "KAPITALANDELE" not in line:
                    ...
                    if match:
                        data.append({"COMPANY": match.groups()[0], "SHAREHOLDER": "Danica Pension", "STAKE": f"{match.groups()[1]} million DKK","REPORT DATE": date.today(), "FILING DATE": date, "FORM LINK": f"https://danica.dk/regnskaber/aarsrapporter{pdf_url}"})
